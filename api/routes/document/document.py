...
@document_router.get("/modified-part/{folder_id}/{doc_id}", response_model=SuccessResponse)
async def get_modified_part(
    ...
    """
    try:
        changed_part = await document_service.compare_two_docs(doc_id=doc_id, folder_id = folder_id)
