...
# 2. 역할(Role)을 위한 Enum 클래스 정의 (변경 없음)
...
class ChatRoom(Base):
    ...
    participants: Mapped[List["User"]] = relationship(secondary="user_chat_room", back_poupulates="chat_rooms")
